Vue.component("viewFriendsPost",{
	...
	methods:{
		...
		back: function(){
			this.$root.$router.push('/friendProfile/' + this.$route.params.username + '/' + this.$route.params.friendUsername)
		},
	...
	created(){
		axios.get('rest/user/post/' + this.$route.params.friendUsername + '/' + this.$route.params.imageId)
            	.then((res) => {
